...
// order (src/types/danceSchedule.ts), which lists Intro/Various alongside the linear
// levels even though they aren't points on this scale. Used to drive the
...
// Intro/Various — is always visible, since those aren't points on this
