  ...
  return (
    <div className={styles.filters}>
      ...
      <div className={`${styles.field} ${styles.levelField}`}>
        {/* .levelInner, not .levelField itself, carries the min-width the tick labels
            need to avoid overlapping — .levelField only scrolls horizontally
            (overflow-x: auto) when that min-width exceeds the available line width,
            e.g. at Extra Large text size on a narrow phone. See both classes' own
            comments in DanceScheduleFilters.module.css for why. */}
